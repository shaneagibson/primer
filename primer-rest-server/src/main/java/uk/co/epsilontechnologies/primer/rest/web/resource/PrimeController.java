...
public class PrimeController {
    ...
    public ResponseEntity handlePrimedRequestNotInvokedException(final PrimedRequestNotInvokedException primedRequestNotInvokedException) {
        logException("Primed Request Not Invoked: "+primedRequestNotInvokedException.getPrimeRequestList(), primedRequestNotInvokedException, System.out);
    ...
    public ResponseEntity handleRequestNotPrimedException(final RequestNotPrimedException requestNotPrimedException) {
        logException("Request Not Primed: "+requestNotPrimedException.getHttpMethod()+" "+requestNotPrimedException.getRequestPath()+" "+requestNotPrimedException.getRequestBody(), requestNotPrimedException, System.out);
        return new ResponseEntity(HttpStatus.BAD_REQUEST);
    }

    private void logException(final String message, final Exception exception, final PrintStream printStream) {
        printStream.println("--------------------------------");
